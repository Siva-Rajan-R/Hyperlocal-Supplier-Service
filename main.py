...
from api.routers.v1 import supplier_routes,customfield_router
...
async def supplier_service_lifespan(app:FastAPI):
    try:
        ...
        await init_pg_db()
        await init_read_db()
        print("[SUPPLIER SERVICE] [OK] Database & Read DB initialized. Ready for background tasks & exports.")
